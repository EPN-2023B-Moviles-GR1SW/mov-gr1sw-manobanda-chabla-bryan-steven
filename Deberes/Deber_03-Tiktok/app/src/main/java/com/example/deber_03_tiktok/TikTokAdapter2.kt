...
class TikTokAdapter2(private val dataList: List<TikTokItemModel>) : RecyclerView.Adapter<TikTokAdapter2.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val personaCircleImageView: CircleImageView =
            itemView.findViewById(R.id.btn_persona)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.activity_tik_tok_adapter2, parent, false)
